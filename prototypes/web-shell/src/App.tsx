...
import { clusters, edges, inboxItems, nodes } from "./data/seedThoughtAtlas";
  ...
  return (
    <main className="app-shell">
      <section className="topbar" aria-label="Thought Atlas overview">
        <div>
          <p className="eyebrow">Local-first Jarvis workspace</p>
          <h1>Thought Atlas</h1>
        </div>
      ...
      <section className="workspace">
        ...
        <aside className="inspector-panel" aria-label="Inspector and reports">
...
function ClusterReportPanel({
  ...
  return (
    <section className="detail-card cluster-report">
      <div className="panel-heading">
        <p className="eyebrow">Cluster report</p>
        <h2>{cluster.name}</h2>
      </div>
